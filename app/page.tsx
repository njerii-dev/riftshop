          ...
          {products.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {products.map((product, index) => (
                ...
                >
                  {/* Product Image */}
                  <div className="product-image relative w-full h-48 bg-neutral-900 flex items-center justify-center overflow-hidden">
                    {product.image_url ? (
                      <img
                      ...
                      /* This is the fallback if no image is in the DB */

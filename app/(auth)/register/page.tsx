      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="glass rounded-3xl p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white/10 border border-white/20 text-white hover:bg-white/20 transition-colors">
